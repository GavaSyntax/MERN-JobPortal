...
const UpdateJob = () => {
    ...
    const {_id,jobTitle,companyName,minPrice,maxPrice,salaryType,
        jobLocation,postingDate,experienceLevel,companyLogo,employmentType,description,postedBy,skills}= useLoaderData();
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
      ...
      <div className="lg:w-1/2 w-full">
            ...
            <input type="date" placeholder={postingDate} defaultValue={postingDate}
