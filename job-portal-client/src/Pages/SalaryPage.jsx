    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
       ...
       <div className='mt-5'>
             <div className='search-box p-2 text-center mb-2'>
                <input type="text" name="search" id="search" placeholder='Search estimate salary for jobs here. Eg:Backend Developer' className='py-2 pl-3 border focus:outline-none  lg:w-6/12 mb-4 w-full'
