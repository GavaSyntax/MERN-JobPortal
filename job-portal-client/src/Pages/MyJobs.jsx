...
const MyJobs = (user) => {
  ...
  const currentJobs =jobs.slice(indexOffFirstItem,indexOfLastItem);
       ...
       <div className="my-jobs-container">
          ...
          <div className='p-2 text-center mb-2'>
             ...
             onKeyPress= {handleKeyPress}
              type="text" placeholder="Search Your Job Here"name="search" id="search" className='py-2 pl-3 border focus:outline-none lg:w-6/12
             mb-4 w-full' />
...
{/**pagination */}
<div className='flex justify-center text-black font-bold mb-8 space-x-8'>
  {
     currentPage >1 && (
